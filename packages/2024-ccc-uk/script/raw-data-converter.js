  ...
  .reduce((first) => {
    return {
      ...
      text: {
        ...
        second: {
          first: `你還記得布查大屠殺嗎？戰爭的殘忍景象曾讓全球民主國家憤慨，各國政要紛紛表達支持烏克蘭。兩年過去了，不少西方國家已經產生戰爭疲勞，質疑為何繼續資助這場戰爭的聲音愈來愈高；一般人的悲憫之情也在消退，對戰爭畫面已逐漸無感。\n\n張乾琦始終沒有忘記烏克蘭。他在文章裡說，當奧地利人以高空煙火慶祝新年時，烏克蘭人卻在爆炸聲中驚醒。他冒著嚴寒浴雪而行，第八次前往烏克蘭戰地，見證前線「絞肉機」般漫長艱苦的戰況。（備註：原文以英文寫成，經翻譯後由張乾琦校正）`,
          pairs: [
            {
              head: '',
              body: `2023年12月29日，俄羅斯全面入侵烏克蘭的第674天，我正在一班從烏克蘭首都基輔（Kyiv）出發、前往西部城市利沃夫（Lviv）的早班火車上。我對於即將在奧地利與孩子團聚，一同慶祝新年充滿著期待。火車啟程後不久，我收到一封簡訊，在烏克蘭新聞通訊社擔任編輯的朋友Peter詢問我行程是否遭到延誤？我說沒有，但為什麼這樣問呢？他立即回復，告知一個嚴峻的情況：「…今天早上，空中有許多敵人的導彈…眾多死亡和破壞…」\n\n反思之後，我意識到前一晚我的飯店走廊中不斷回盪著持續而尖銳刺耳的空襲警報聲。廣播系統一再指示客人迅速前往指定的飯店防空避難所。隨後的調查揭示，俄羅斯發動了一場全面的空襲。透過社群媒體Telegram的及時新聞更新，得知這是自2022年2月起俄羅斯全面攻擊以來，規模最大的一波攻勢。值得注意的是，在長達18小時的空中彈幕中，烏克蘭的防空系統成功攔截了大多數針對主要城市的122枚導彈和36架伊朗見證者  (Shahed) 自殺無人機的攻擊。\n\n2023年的結束，悲劇地與其開始一樣，體現著烏克蘭人民正承受著的嚴重暴力。儘管我的火車一直平穩向西行駛，卻遇到數次了行程外的臨時停靠。與此同時，令人不安的新聞更新持續透過手機簡訊傳遞而來，詳細描述了一些悲痛慘烈事件，包括婦產科醫院、學校和公寓大樓遭受摧毀破壞。\n\n此刻，我思忖著是否能及時抵達利沃夫，以趕上預定前往波蘭克拉科夫 (Krakow) 機場的交通工具。與此同時，我感到一種不安―這是由於缺乏戰鬥後解壓期 (通常約需7至14天)―因為我從烏東頓巴斯前線，經過基輔，然後就已直接在回家的路上。我的心理狀態仍然深陷在戰區，對可能在頭頂上出現的無人機活動保持高度警覺，以及來自遠處空中，超音速飛行、人眼不可見的的火箭和迫擊炮的不祥威脅，接著是爆炸後的震盪和耳畔一直有著揮之不去的轟鳴聲。但這些不就是創傷後壓力症候群（PTSD）的症狀嗎？\n\n與俄羅斯投入的軍火相較，烏克蘭的炮火反擊僅為其四分之一，造成這種不對稱的顯著因素之一，據2023年11月14日的美聯社（AP）新聞報導，其中引述了白宮的消息， 報導稱北韓向俄羅斯輸入了超過1,000個貨櫃的裝備和彈藥。這些軍火包括短程彈道飛彈、反坦克飛彈、迫擊炮、火箭發射器和炮彈。此外，美國和歐盟在人道援助和軍事支援方面已經明顯不足。北約因被認為缺乏果斷行動力，而被戲稱為「只說不做」(No Action Talk Only, NATO是北約的英文縮寫)。而這增加了烏克蘭在持續衝突中所面臨的挑戰。\n\n\n冬季來臨減緩了戰爭的推進，促使烏克蘭將其戰略焦點轉向防禦工事，包括構築反坦克三角水泥龍牙棒樁，鐵絲刺網路障和挖掘壕溝。有一天早晨，我獲准隨軍採訪狂怒旅 (Fury Brigade)，這是一支由前警察執法人員組成的部隊，駐紮在前線城鎮科斯蒂亞蒂尼夫卡（Kostiantynivka）附近。在這裡，我目睹了AZP S-60 57mm高射炮的迅速部署，啟動後產生強大的崩裂聲，將炮彈密集狂射向俄羅斯的陣地。\n\n與該旅新聞官代號 Bars的對話中，他傳達了一個信息，即儘管他們的部隊持續不歇從陸地和空中發動了猛烈的攻擊，導致俄羅斯軍隊遭受了重大損失，但敵人仍然一再地挺進。這一認識強調了用「絞肉機」（meat grinder）一詞來描述這場戰爭的漫長而艱苦、悲慘而殘酷的本質。\n\n有關烏克蘭和俄羅斯的確切部隊數量和傷亡人數仍然未公開，皆為保密狀態。儘管缺乏官方統計數據，但烏克蘭士兵、志願役和徵召兵在過去數個月的戰爭中持續承受嚴酷考驗。烏克蘭國內民眾逐漸認知到一點，這也表示他們必須做好準備，準備長期投入衝突對抗。而起初企盼戰爭能在2024年劃下句點的樂觀情緒，正一點一滴地消逝。\n\n\n作為對長期參與的回應，烏克蘭內閣正在起草一項新的強制兵役法。截至2月12日，這項法案已提交給議會進行通過，並在第一次審閱中獲得批准。總統澤倫斯基 (Volodymyr Zelensky)必須簽署該法案，然而這並不受到民眾支持。它可能會將徵兵年齡從27歲降低到25歲的男性，擁有醫學或藥學教育背景的女性也將被強制徵召。逃避強制兵役的處罰可能也會被納入其中。這項新法律強調了該國對衝突持久性的認識。受到新法律影響的其中一人是我之前的新聞嚮導 (fixer)，目前正在接受軍事訓練的Serhiy。我曾與其他三位新聞嚮導合作，他們都已婚，也都可能在今年面臨強制徵兵。\n\n在與馬爾基夫斯卡（Markivska）附近狂怒旅的士兵互動期間，我與一位105公厘榴彈炮助理炮手交談，他以代號“Happy”（快樂）而聞名，他友善的舉止，始終洋溢在他充滿笑容的臉上。在操作榴彈炮的射擊和裝填之間，他說他僅接受三天的火炮操作訓練。他主要是通過YouTube，獲得了額外的技能。\n\n穿越20公分深的黑色、潮濕、黏滑的泥濘地，對於我這個63歲、癌症倖存者來說是相當具有挑戰性的，而對我的新聞嚮導Slava來說，儘管比我年輕30歲，他也遇到類似的困難。然而，我們必須移動迅速，避免遭俄羅斯偵察或自殺型無人機發現。每到一個獲准前往的前線基地時，部隊指揮官或新聞官員總是首先告知，若遭遇俄羅斯火箭炮襲擊，我們該由哪一條路線盡快通往戰壕庇護所。\n\n穿越骯髒泥濘的地形時，全身灰溜溜的老鼠在我眼前竄來竄去。對於在潮濕、黑暗、面積僅10平方米、在地下兩米深的狹小壕溝休息處的三名士兵來說，老鼠是一個持續的困擾。黑暗像一層厚重的幕布籠罩著狹窄的空間。一盞孤寂昏黃、閃爍的LED燈發出微弱光芒，映照著一片了無生機、寂靜籠罩的幽冥八荒，只有偶爾傳來老鼠爬行的聲音在漆黑中迴盪。士兵們缺乏有效的對策，只能寄望陣地裡的來回穿梭的黃鼠狼捉老鼠。與此同時，一片死寂靜默的陣地裡，突然間、無預警、不停歇、又是此起彼落的炮擊，猶如柴可夫斯基《1812序曲》最後樂章中華麗彭湃卻又令人憎厭的的11響炮聲，前線的現實簡單粗暴地提醒著他們每天所面對的殘酷環境，以及生與死不歇的無常。下一次火箭襲擊的時間和地點，未知。\n\n自1917年以來，烏克蘭根據東正教的曆法，總在1月7日慶祝聖誕節。直到2023年，烏克蘭正式與其他西方基督教徒一樣改在12月25日慶祝聖誕節。這一天，基輔蘇菲亞廣場（St. Sophia Square）上的人工聖誕樹高達12米，點綴著該國國旗顏色藍與黃的心形裝飾，上面有著烏克蘭的國徽，這是近一個世紀以來，烏克蘭首次象徵性地拉開與俄羅斯的距離。自俄羅斯入侵以來，烏克蘭已採取種種措施，如更改街道名稱和拆除紀念碑，以弭除俄羅斯和蘇聯帝國時期的痕跡。\n\n聖誕節前兩天，我拍攝了在烏東前線小鎮基夫沙里夫卡（Kindrativska）附近425特種突擊旅Skala的狙擊手部隊，38歲的副指揮官代號是Best，他以該部隊最頂尖的狙擊手而聞名。我問他們聖誕夜要做什麼？Best咧嘴笑著說：「我們要戰鬥！」在Best的臨時辦公室裡，兩個即時傳送的無人機偵察影像顯示在兩台43英寸的平板電視上，呈現出一個處處斷垣殘壁，幾乎無法辨認的巴赫穆特 (Bakhmut)。Best分享了一段影片，展示了他在1,770米和1,820米的距離外擊中兩名移動中的俄羅斯士兵，他語帶自豪，強調其中的複雜度―包括風阻、彈道和因地球自轉使得物體運動時呈現複雜曲線的科氏效應  (Coriolis Effect)。螢幕上，一架俄羅斯無人機迅速飛過並隱沒至視線之外，這凸顯了威脅始終存在的事實。\n\n在這個部隊裡，42歲的司機曾是一名煤礦工人，現在他擁有除了駕駛之外的技能，包括射擊和操控無人機。每位部隊成員都具有相同能力。在採訪期間，他為我和新聞嚮導準備了傳統的紅色羅宋湯。他說，他的母親每天都會到教堂為每一位士兵祈禱。至截稿前，他們的部隊仍然投入在巴赫穆特周邊的作戰行動中。\n\n隨後，在基夫沙里夫卡（Kivsharivka）附近，一名當地東正教牧師，在教堂裡為年長者和士兵祈禱祝福，營造出一種敬畏和驚嘆的氛圍，只有來自遠處炮擊的衝擊波打斷了這片肅穆寧靜。儀式結束後，鐘聲響起，飽滿濃烈的鈴聲在四周迴盪。\n\n鐵軌發出刺耳聲響、火車突然停止，行程中斷，孩子看著他們的父母；乘客想找出旅程受到干擾的原因。沒有發生空襲抑或響起警報，附近也沒有戰鬥機飛行。是虛驚一場嗎？我不知道，我只知道在外頭，冬天的景象在貧瘠但如電影般的全景中展開，露出地平線的田野，如此平坦遼闊，我幾乎可以感覺到地球兩端的曲率。幾分鐘後，火車鳴笛，聲音響徹雲霄，宣告旅程繼續。\n\n在我旁邊的乘客Aleks來自基輔，是一位農業工程師，經常出差。我們談論了世界上主要的地區衝突，像是納戈爾諾-卡拉巴赫（Nagorno-Karabakh）、以色列和哈馬斯、朝鮮半島、南海、以及台灣和中國之間的緊張局勢。他問我，台灣是否有從烏克蘭和俄羅斯戰爭中學到教訓，並且做好自衛的準備？我聳聳肩說道，當然希望如此，因為我相信，一個國家的和平與安全必須植根於其維護和保護其人民、土地和主權的力量和能力上。此外，我們不要忘記，台灣雖然不大，卻迷人親切，且蘊含微妙而隱密的力量。\n\n台灣人民是否要為不可避免的情況做好準備，這是一個值得嚴肅考慮的問題。令人不安的是看到馬前總統接受德國之聲（DW）的訪談時，他提議台灣應該設法以一切可能的方式安撫中國。35年來，我經常在局勢不穩定的地區旅行、拍攝記錄，遇到這種希望採納侵略者的觀點、合理化或為其辯護的個人是極為罕見的。這種複雜的心理動態，以及對遭虐待的否認，這不就與斯德哥爾摩綜合症（Stockholm Syndrome）的概念相符嗎?\n\n一個令人痛心的例子是香港。2019年，我曾六次前往這座城市，記錄報導了百萬港人的反送中抗議行動。然而，隨後在2020年初，嚴苛的國家安全法（NSL）隨之頒布實施，香港自此走向令人憾惜的轉變 — 從眾所周知的自由社會、璀璨的大都會和「亞洲最好的城市」，變為已從昔日光輝蒙上陰影，一座需不斷面對額外治理的歐威爾式的島城。\n\n幸運的是，我的火車準時抵達了利沃夫，沒有任何耽擱。儘管如此，到了跨越邊境時，氣氛由令人期待變得充滿沮喪。由於烏克蘭和波蘭的邊境手續有時錯綜複雜，接下來是四小時的漫長等待。這意外的延誤導致我錯過了航班。雖然心情沮喪，但我立刻決定搭次日第一班飛機回家。這次經歷和意想不到的障礙，也再次說明了，旅行本就充滿許多不可預測的事物。\n\n從飽受戰爭蹂躪的烏克蘭回來，能夠抱著孩子，喜悅是難以言喻的。每一次擁抱，都感覺是從混亂的衝突中成功奪回的寶貴時刻。然後，隔天晚上，接近午夜時分，隨著午夜教堂鐘聲敲響新年，奧地利格拉茲（Graz）搖身一變，成了一場高空慶典。黑夜綻放出耀眼的光芒，煙火從各個角落點燃、射出、噴發，點綴天鵝絨般的夜空。與此同時，歡天喜地的鄰居們在庫爾夥伴(Kool & The Gang)的〈Celebration〉或麥可布雷（Michael Bublé）的〈It's a Beautiful Day〉等旋律中，舉杯跳舞。\n\n1月3日，俄羅斯全面入侵烏克蘭的第679天，烏克蘭總統澤倫斯基表示，俄羅斯在僅僅五天內就發射了500枚導彈和無人機對烏克蘭進行攻擊。全國至少有60人在這波襲擊中喪生，東北部的卡爾科夫（Kharkiv）、南部的札波羅熱（Zaporizhia）、南部海岸的敖德薩（Odesa），甚至最西部的利沃夫等城市，都深受重擊。\n\n數百萬烏克蘭人在爆炸聲中驚醒，這或許提醒了大家，這些聲響應該在全球引起共鳴。烏克蘭官員呼籲西方盟友增加空中防禦，這也彰顯了由於戰爭疲勞而導致的支持壓力。英國的堅定支持受到關注，其首相蘇納克（Rishi Sunak）強調，只要有需要，就必會與烏克蘭同在。\n\nPeter，我在基輔Interfax-Ukraine新聞社的編輯朋友，一直在社群媒體Substack（"ukraine@war"）上撰寫有關戰爭過去兩年的文章。自2022年2月24日俄羅斯全面入侵烏克蘭，到今年2月24日即將滿兩年了。他強調365 + 365天的累積影響，相當於730天。不僅於此，他再加上另外的2922天，標誌著自俄羅斯於2014年2月入侵並吞併克里米亞半島以來的十年。也就是說，烏克蘭總計已經持續3,652天與世界第二大軍事強權進行血腥的衝突和對抗。烏克蘭的志願者和士兵，已經在多年戰鬥中磨練出經驗，持續以堅定不移的決心和必須忍受進一步逆境的強大精神，以確保自己的國家能夠生存下來。勿忘烏克蘭！`,
            },
          ],
        },
      ...
      eng_text: {
        ...
        credit: {
          pairs: [
            ...
            'Curation, design and development by: Wen-Han Lee, Lee-Yu Tseng, Yu-Ju Lee, I-Ching Wang',
